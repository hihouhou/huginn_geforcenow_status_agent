module Agents
  class GeforcenowStatusAgent < Agent
    ...
    description do
      <<-MD
      The huginn Geforcenow status agent checks the Geforcenow service status.
    ...
    def check_status()
      ...
      uri = URI.parse("https://status.geforcenow.com/api/v2/status.json")
      request = Net::HTTP::Get.new(uri)
      request["Authority"] = "status.geforcenow.com"
      request["Accept"] = "*/*"
